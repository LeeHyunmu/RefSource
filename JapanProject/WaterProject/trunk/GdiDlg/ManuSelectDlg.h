...
class CManuSelectDlg : public CDialogImpl<CManuSelectDlg>, public CMessageFilter
{
	//배경 이미지
	...
	HWND hWnd;
public:
	enum { IDD = IDD_MANUSELECTDLG };

	BEGIN_MSG_MAP(CManuSelectDlg)
