...
#ifndef __WATERCMD_74F736E25AB94b5dA789E4730F58F2A1_H__
#define __WATERCMD_74F736E25AB94b5dA789E4730F58F2A1_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
//Reader Event Func
typedef DWORD (WINAPI *WATERCHECKFUNC)(LPVOID lpThreadParameter, CWaterCmdFormat::WaterCheck check);
typedef WATERCHECKFUNC WATERCHECKFUNC_ROUTINE;
class CWaterCmd
{
	//싱글턴 객체
	static CWaterCmd* AQdeviceSingle;
	...
	CSerial nfcserial;
	//Resp Func Code
	CWaterCmdFormat::WaterCheck RespFuncFlag;
	//Resp Error Code
	CWaterCmdFormat::WaterErrorCode RespErrorCode;
	// 받은 데이터 길이
	...
	//Command Data
	UINT makeCommandData(CWaterCmdFormat::WateAddress cmd, byte* data, int datalen, byte* CommandData, int& CommandDatalen);
	//실제 파서할 데이터 추출 함수
	...
	BOOL NfcEventLoop();
	//Serial Polling Loop
	CWaterCmdFormat::WaterErrorCode NfcResponseLoop(CWaterCmdFormat::WaterCheck& func, byte* data, int readlen);
...
public:
	...
	~CWaterCmd(void);
	//NFC 기능 생성 메니저
	CWaterCmdFormat::WaterErrorCode initAQNFC(LPVOID lpThreadParameter, WATERCHECKFUNC_ROUTINE _watercheckfunc);
...
#endif// __WATERCMD_74F736E25AB94b5dA789E4730F58F2A1_H__
