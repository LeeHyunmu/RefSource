...
//CSuperEditImpl* edit=new CSuperEditImpl;
//edit->Create(hWnd,CRect(subeditdata[0],subeditdata[1],subeditdata[2],subeditdata[3]),NULL,WS_CHILD|WS_VISIBLE,WS_EX_CLIENTEDGE,subeditdata[4],NULL);