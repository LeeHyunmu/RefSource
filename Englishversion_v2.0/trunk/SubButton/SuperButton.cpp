...
//
void CSuperButton::SetChangeXPos()
{
	xpos-=width;
	if(xpos<0)
	{
...
//
BOOL CSuperButton::MoveXAnimation(int& xmove)
{
	BOOL b=FALSE;
	if(xmove>width)
	{
...
//
void CSuperButton::SetChangeYPos(HDWP _hdwp)
{
	ypos-=Height;
	if(ypos<0)
	{
...
//
BOOL CSuperButton::MoveYAnimation(HDWP _hdwp, int& ymove)
{
	BOOL b=FALSE;
	if(ymove>Height)
	{
