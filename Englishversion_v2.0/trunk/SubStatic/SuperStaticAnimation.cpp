...
//|
//---------------------------------------------------------------
void CSuperStaticAnimation::initSuperStatic(UINT ImageId, UINT imgcount,  BOOL bOwnerDraw)
{
	...
	if(DivideHbitmap(HBITMAP(bit), imgcount))
	{
		SIZE bmSize;
...
//|
//---------------------------------------------------------------
void CSuperStaticAnimation::initSuperStatic(UINT ImageId, LPCWSTR type, BOOL bOwnerDraw)
{
	fontinfo.lfHeight   = 12;
	fontinfo.lfWeight   = 0;
	fontinfo.lfEscapement  = 0;
...
//|
//---------------------------------------------------------------
void CSuperStaticAnimation::initSuperStatic(CBitmapHandle bit, UINT imgcount,  BOOL bOwnerDraw)
{
	fontinfo.lfHeight   = 12;
	fontinfo.lfWeight   = 0;
	fontinfo.lfEscapement  = 0;
...
//|
//---------------------------------------------------------------
void CSuperStaticAnimation::initRgnSuperStatic(UINT ImageId, UINT MaskId, UINT imgcount,  BOOL bOwnerDraw)
{
	fontinfo.lfHeight   = 12;
	fontinfo.lfWeight   = 0;
	fontinfo.lfEscapement  = 0;
	...
	pBitmap.Load(ImageId,"PNG");
	CBitmap bit = pBitmap.GetWinBitmap();
	if(bit && RgnDivideHbitmap(HBITMAP(bit), imgcount))
	{
		SIZE bmSize;
		staticimage[0].GetSize(bmSize);
		SetWindowPos(NULL, 0,0, bmSize.cx,bmSize.cy,SWP_NOMOVE|SWP_NOOWNERZORDER);
...
//|
//---------------------------------------------------------------
BOOL CSuperStaticAnimation::DivideHbitmap(CBitmapHandle hbit, UINT imgcount)
{
	SIZE bmSize;
...
//|
//---------------------------------------------------------------
BOOL CSuperStaticAnimation::RgnDivideHbitmap(CBitmapHandle hbit, UINT imgcount)
{
	SIZE bmSize;
	if(hbit.GetSize(bmSize))
	{
