...
//|
//---------------------------------------------------------------
BOOL GAFileStream::CreateLineReadFile(CString filename, vecString& vecfile)
{
	TCHAR fullpath[MAX_PATH];
	TCHAR path[MAX_PATH];
	GetCurrentDirectory(MAX_PATH, path);
	sprintf_s(fullpath, _T("%s\\%s"),path, filename);
	TCHAR buf[MAX_PATH];
	int len;
	FILE* fp;
...
//|
//---------------------------------------------------------------
BOOL GAFileStream::CreateLineWriteFile(CString filename, vecString& vecfile)
{
	TCHAR fullpath[MAX_PATH];
	TCHAR path[MAX_PATH];
	GetCurrentDirectory(MAX_PATH, path);
...
//|
//---------------------------------------------------------------
BOOL GAFileStream::CreateReadFile(CString filename, LPBYTE& bytefile, DWORD& dwFileSize)
{
	HANDLE hFile;
