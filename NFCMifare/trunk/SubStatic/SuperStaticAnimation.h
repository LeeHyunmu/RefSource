...
public:
...
#ifdef WINCE
	void initSuperStatic(UINT ImageId, LPCWSTR type, UINT imgcount, BOOL _bXCount=FALSE, BOOL bOwnerDraw=TRUE);
#endif //WINCE
	...
	//Rgn 
	BOOL RgnDivideHbitmap(CBitmapHandle hbit, UINT imgcount, BOOL _bXCount);
	//Div Rgn 만들기
	BOOL DivideHRgn(CBitmapHandle hbit, UINT imgcount, BOOL _bXCount);
	//
	BOOL SetAnimation();
#ifdef WINCE
