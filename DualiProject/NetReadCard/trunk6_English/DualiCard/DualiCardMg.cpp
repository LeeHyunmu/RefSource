...
#define MODESTRING_1 _T("Bell control mode!!")
#define MODESTRING_2 _T("Bell control mode off!!")
#define MODESTRING_3 _T("Bell control mode Setting!!")
#define MODESTRING_4 _T("Carmera control mode!!")
#define MODESTRING_5 _T("Carmera control mode off!!")
#define MODESTRING_6 _T("Carmera control mode Setting!!")
			...
			if(cardID.IsEmpty())
			{
				...
				if(cardID.GetLength())
				{
					...
					if(FindCard())
					{
						...
						{
							maingdi->SetListString(_T("Phone connect!!"));
							BOOL bb;
							CString PhoneRecv="";
							...
							if(cardID.CompareNoCase(PHONE_1)==0)
							{
								if(Mode==0)
								{
									ModeString=MODESTRING_1;
								}
								else if(Mode==1&&PhoneMode[0]==1)
								{
									ModeString = MODESTRING_2; PhoneMode[0]=0;
								}
								else if(Mode==2&&PhoneMode[0]==2)
								{
									ModeString = MODESTRING_5; PhoneMode[0]=0;
								}
								else
								{
									ModeString = Mode==1?MODESTRING_3:MODESTRING_6; PhoneMode[0]=Mode;
								}
							}
							else
							{
								if(Mode==0)
								{
									ModeString=MODESTRING_4;
								}
								else if(Mode==1&&PhoneMode[1]==1)
								{
									ModeString = MODESTRING_2; PhoneMode[1]=0;
								}
								else if(Mode==2&&PhoneMode[1]==2)
								{
									ModeString = MODESTRING_5; PhoneMode[1]=0;
								}
								else
								{
									ModeString = Mode==1?MODESTRING_3:MODESTRING_6; PhoneMode[1]=Mode;
								}
							}
