...
#define DEBUGMODE	1		//0: not display debug msg, 1: display debug msg
...
//Type B
extern "C" API_DLL int WINAPI DEB_Transparent(int nPort, int datalen, LPBYTE data, BYTE TOUT, LPINT outlen, LPBYTE lpRes);
