...
//|
//---------------------------------------------------------------
HRESULT CADODatabase::BeginTransaction() 
{
...
//|
//---------------------------------------------------------------
HRESULT CADODatabase::CommitTransaction() 
{
...
//|
//---------------------------------------------------------------
HRESULT CADODatabase::RollbackTransaction() 
{
...
//|
//---------------------------------------------------------------
BOOL CADODatabase::Execute(LPCTSTR lpstrExec, long Option)
{
	...
	try
	{
		...
		m_pConnection->Execute(_bstr_t(lpstrExec), &vRecords, Option);
